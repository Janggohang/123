...
class DeliveryPostEditingActivity : AppCompatActivity() {
        ...
        binding.photoButton.setOnClickListener {
            when {
                PermissionChecker.checkSelfPermission(
                    this@DeliveryPostEditingActivity,
        ...
        binding.submitBtn.setOnClickListener{
            ...
            if (selectedUri != null) {
                ...
                uploadPhoto(photoUri,
                    ...
                    errorHandler = {
                        Toast.makeText(this@DeliveryPostEditingActivity,
                            "사진 업로드에 실패했습니다!!!",
    ...
    private fun loadPostData() {
        binding.titleEdit.setText(currentDelivery.title) // 제목
        // ImageView에 이미지 로드
        ...
        binding.priceEdit.setText(currentDelivery.price.toString()) // 가격
        binding.countEdit.setText(currentDelivery.numOfPeople.toString()) // 인원 수
        binding.pricePerText.text = (currentDelivery.price/currentDelivery.numOfPeople).toString() // 인당 가격
        binding.myLocation.text = currentDelivery.location // 위치
        binding.contentEdit.setText(currentDelivery.content)
    }
    ...
    private fun editingPost(imageUri: String) {
        ...
        val postRef = mDbRef.child("delivery").child(DeliveryViewerActivity.currentDelivery.postId)
        // 게시글 수정
    ...
    private fun showPermissionContextPopup() {
        AlertDialog.Builder(this@DeliveryPostEditingActivity)
            .setTitle("권한이 필요합니다.")
